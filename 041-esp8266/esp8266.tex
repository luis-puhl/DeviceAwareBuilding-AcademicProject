...
\emph{AMS1117 3v3} e dois capacitores de $100 \mu F$. Na \autoref{table:custo-esp} e \autoref{table:acessorios-esp},
são apresentados os custos de cada módulo testado e dos acessórios utilizados em conjunto.

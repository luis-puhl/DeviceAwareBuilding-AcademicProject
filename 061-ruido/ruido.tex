...
Onde, na \autoref{eq:fspl}, $\lambda$ é o comprimento de onda do sinal em metros
...
\autoref{chap-android-kuik}), desenvolvida por \citeonline{Kuik2016}, e no
trabalho de \citeonline{androidtri} a FSPL é usada de maneira inversa, ou seja,

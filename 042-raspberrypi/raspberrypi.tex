...
O RPI3 foi adotado como plataforma para o sensor de detecção de dispositivos pois
o modo promíscuo (monitor mode) conseguiu ser acessado através de adaptador USB Wi-Fi
apesar do esforço de utilização da plataforma ESP8266 que reduziria significativamente o
custo de cada sensor. Para comparação do custo da aplicação aqui proposta veja a Tabela

...
\midrule
Memória logo termo	&	 cartão SD (usualmente 8 ou 16 GB)		&	\emph{SPI flash} de 4 MB		\\
\midrule
Tamanho físico		&	 85x56mm								&	 24x13mm	\\
\midrule
Rede embutito		&	 Megabit Ethernet, 802.11 b/g/n			&	802.11 b/g/n	\\
\midrule
Expanção			&	  USB, DSI, CSI e GPIO					&	Somente GPIO	\\
\midrule
...
pois o modo promíscuo (monitor mode) conseguiu ser acessado através de adaptador
USB Wi-Fi apesar do esforço de utilização da plataforma ESP8266 que reduziria
...
custa aproximadamente 10 vezes mais por sensor do que a plataforma ESP8266. Isto
...
Para a construção do \emph{Gateway IoT} as exigências de \emph{hardware}, onde
espera-se do \emph{gateway} capacidades de mínimas de processamento,
armazenamento e comunicação, e de \emph{software}, onde o mínimo é um sistema
operacional quee suporte um \emph{MQTT Broker}. Portanto para o \emph{gateway} a
plataforma ESP8266 clarmente não é adequada e um RPI3 representa o custo mínimo.
...
\begin{tabular}{c|cr}
	...
	\midrule
	Plataforma				&	RPI3				&	190,00			\\
	Fonte de alimentação	&	Fonte Usb iPad		&	13,99			\\
	Fonte de alimentação	&	Cabo Usb A-micro	&	2,00			\\
	Memória			 		&	SD c10 16GB			&	21,99			\\
	\midrule
	Total por Gateway		&						&	227,98			\\
	\midrule
	\bottomrule
\end{tabular}%
}{%
